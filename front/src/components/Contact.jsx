  ...
  return (
    <div id="contact" className="my-20 min-h-96 w-screen  px-10">
      <div className="relative rounded-lg bg-black py-24 text-blue-50 sm:overflow-hidden">
        ...
        <div className="absolute right-10 top-1/2 hidden w-60 -translate-y-1/2 md:block lg:top-20 lg:w-80 lg:translate-y-0">
          <ImageClipBox
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <AnimatedTitle
            ...
            containerClass="special-font w-full font-riot text-4xl sm:text-5xl md:text-[6.2rem] font-black leading-[.9]"
          />
