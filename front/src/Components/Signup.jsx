        ...
        <div className="relative h-screen w-screen overflow-hidden">
            ...
            <div className="relative z-20 flex h-full items-center justify-center p-4">
                <div className="w-full max-w-md bg-black/30 backdrop-blur-md p-8 rounded-2xl border border-white/10 shadow-2xl">
                    ...
                    <h2 className="text-2xl font-bold mb-6 text-center text-blue-100 font-robert-regular">Create Account</h2>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4 font-general">
                        <div>
                            <label className="block text-blue-50 mb-1 text-xs uppercase tracking-wider">Full Name</label>
                            <input
                                type="text"
                                value={name}
                    ...
                    <p className="mt-6 text-center text-blue-50 text-sm font-general">
                        ...
                        <Link to="/login" className="text-yellow-300 hover:text-yellow-200 hover:underline">
                            Log in
                        </Link>
                    </p>
